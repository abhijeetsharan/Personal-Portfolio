      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project) => (
          <motion.div
            ...
            onClick={() => setActiveProject(project.id)}  // Enable click functionality
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: activeProject === project.id ? 1 : 0 }}  // Show on hover or click
              transition={{ duration: 0.5 }}
              className="absolute inset-0 flex flex-col items-center justify-center text-white opacity-0 backdrop-blur-lg transition-opacity duration-500">
